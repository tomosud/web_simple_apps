...
地球表面に配置された200個の赤い点を攻撃するシューティングゲームの実装

#### 実装予定内容
1. **敵配置システム**: 地球表面に200個の赤いスフィア配置
2. **衝突判定システム**: 弾丸と敵の当たり判定・撃破処理
3. **ゲーム進行システム**: スコア、残り敵数、クリア条件
4. **パフォーマンス最適化**: InstancedMesh、LODシステム
